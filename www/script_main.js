...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (openModalBtn && window.openRegisterModal) {
    ...
    if (switchToRegister) {
        switchToRegister.addEventListener('click', function(e) {
            ...
            if (loginModal && window.closeModal) window.closeModal(loginModal);
            setTimeout(() => {
    ...
    if (loginForm && window.authService) {
        loginForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                alert(`С возвращением, ${result.user.username}!`);
    ...
    if (registerForm && window.authService) {
        registerForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                alert(`Добро пожаловать в команду, ${username}!`);
                
                const registerModal = document.getElementById('registerModal');
                if (registerModal && window.closeModal) window.closeModal(registerModal);
                this.reset();
            } catch (error) {
